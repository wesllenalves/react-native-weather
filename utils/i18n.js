...
i18n.translations = {
    ...
    es:{
        ...
        'shower rain and drizzle' : 'ducha lluvia y llovizna',
        'heavy shower rain and drizzle' : 'lluvia fuerte y llovizna',
        'shower drizzle' :  'llovizna de ducha',
        ...
        'light intensity shower rain' : 'lluvia de lluvia de intensidad ligera',
        'shower rain' : 'aguacero',
        'heavy intensity shower rain' : 'lluvia de lluvia intensa',
        'ragged shower rain' : 'lluvia irregular de la ducha',
        'light snow' : 'nieve ligera',
        'Snow' : 'Nieve',
        'Heavy snow' : 'Fuertes nevadas',
        'Sleet' :  'Aguanieve',
        'Light shower sleet' : 'Aguacero ligero',
        'Shower sleet' :  'Ducha aguanieve',
        'Light rain and snow' : 'Lluvia ligera y nieve',
        'Rain and snow' : 'Lluvia y nieve',
        'Light shower snow' : 'Lluvia ligera de nieve',
        'Shower snow' : 'Ducha de nieve',
        'Heavy shower snow' :  'Fuerte lluvia de nieve',
        'mist' : 'niebla',
        'Smoke' : 'Fumar',
        'Haze' : 'Calina',
